...
public static class SkillProbe
{
    ...
    private static readonly (string Skill, string W, string T, string P, string OW, string OT, string OP)[] Cases =
    {
        ...
        ("SKL_DUELIST",     "WPN_SWORD","TAC_COUNTER","PER_CALM",       "WPN_SWORD","TAC_BALANCED","PER_CALM"),
        ("SKL_LUNGE",       "WPN_SPEAR","TAC_ZONER","PER_WARY",         "WPN_AXE","TAC_BRAWLER","PER_RECKLESS"),
        ("SKL_RIPOSTE",     "WPN_SPEAR","TAC_COUNTER","PER_CALM",       "WPN_GREATSWORD","TAC_PRESSURE","PER_BOLD"),
        ...
        ("SKL_ZONELOCK",    "WPN_WHIP","TAC_ZONER","PER_WARY",          "WPN_AXE","TAC_BRAWLER","PER_RECKLESS"),
        ("SKL_SHIELDBLOCK", "WPN_SHIELD","TAC_DEFENDER","PER_HONORABLE","WPN_SWORD","TAC_PRESSURE","PER_BOLD"),
