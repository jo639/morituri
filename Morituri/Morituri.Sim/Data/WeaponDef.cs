...
public static class WeaponTable
{
    ...
    public static readonly WeaponDef Axe         = new("WPN_AXE",         64f, 1, 1.4f, 0.70f, 0.85f, 30f, 60f, 0.55f, 0f,    0f,   true,  1.5f,  1.00f);
    ...
    public static readonly WeaponDef Hammer      = new("WPN_HAMMER",      58f, 1, 1.3f, 0.65f, 0.90f, 45f, 70f, 0.60f, 0f,    0f,   true,  1.5f,  1.00f);
    public static readonly WeaponDef Whip        = new("WPN_WHIP",        35f, 1, 3.0f, 1.05f, 0.50f,  8f, 35f, 0.10f, 0f,    0.10f,false, 0f,    1.00f);
    public static readonly WeaponDef SwordShield = new("WPN_SWORDSHIELD", 40f, 1, 1.5f, 0.90f, 0.50f, 16f, 55f, 0.25f, 0.60f, 0f,   false, 0f,    1.00f);
