...
{
    public static readonly TacticsProfile Pressure  = new("TAC_PRESSURE",  1.0f, 0.45f, 0.70f, 0.35f, 0.10f, 0.20f, 0.15f, 0.50f, 0.10f);
    public static readonly TacticsProfile Counter   = new("TAC_COUNTER",   2.0f, 0.45f, 0.30f, 0.60f, 0.80f, 0.50f, 0.10f, 0.40f, 0.25f);
    public static readonly TacticsProfile Zoner     = new("TAC_ZONER",     2.8f, 0.55f, 0.45f, 0.50f, 0.30f, 0.30f, 0.50f, 0.30f, 0.30f);
    public static readonly TacticsProfile Brawler   = new("TAC_BRAWLER",   0.7f, 0.35f, 0.80f, 0.25f, 0.15f, 0.10f, 0.20f, 0.70f, 0.05f);
    public static readonly TacticsProfile Decision  = new("TAC_DECISION",  2.2f, 0.55f, 0.35f, 0.55f, 0.35f, 0.55f, 0.40f, 0.15f, 0.40f);
    public static readonly TacticsProfile Hunter    = new("TAC_HUNTER",    1.6f, 0.45f, 0.55f, 0.65f, 0.40f, 0.30f, 0.35f, 0.45f, 0.20f,
    ...
    public static readonly TacticsProfile Gambler   = new("TAC_GAMBLER",   1.2f, 0.45f, 0.65f, 0.20f, 0.25f, 0.10f, 0.25f, 0.90f, 0.00f);
    public static readonly TacticsProfile Evader    = new("TAC_EVADER",    2.5f, 0.65f, 0.25f, 0.55f, 0.45f, 0.20f, 0.30f, 0.20f, 0.35f);
    public static readonly TacticsProfile Defender  = new("TAC_DEFENDER",  1.4f, 0.45f, 0.20f, 0.50f, 0.50f, 0.80f, 0.10f, 0.10f, 0.35f);
    public static readonly TacticsProfile Balanced  = new("TAC_BALANCED",  1.6f, 0.45f, 0.50f, 0.45f, 0.35f, 0.40f, 0.30f, 0.40f, 0.20f);
